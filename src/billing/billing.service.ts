    ...
    return [
      {
        ...
        price: 0,
        priceId: null,
        features: ['Basic features', 'Up to 5 members'],
      ...
      },
      {
        ...
        name: 'Starter',
        price: 9,
        priceId: this.configService.get('STRIPE_PRICE_STARTER') || '',
      ...
      },
      {
        ...
        features: ['Everything in Starter', 'Unlimited members', 'API access', 'Custom integrations'],
      ...
      },
      {
        ...
        features: ['Everything in Pro', 'Dedicated support', 'SLA guarantee', 'Custom billing'],
